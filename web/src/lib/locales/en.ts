export default {
  ...
  'sessions.children.expand': 'Expand child sessions',
  'sessions.children.collapse': 'Collapse child sessions',
  'sessions.children.count': '{count} child sessions',
  ...
  'session.automationPaused.title': 'Automation paused',
  'session.automationPaused.body': 'Automation tasks are paused. You can still chat directly; automation sends resume after you press Resume.',
  'session.automationPaused.resume': 'Resume automation',
  ...
  'session.provider.changeTitle': 'Change Codex provider',
  'session.provider.changeRestartNotice': 'The active session will stop and re-open with the selected provider.',
  'session.provider.changeLabel': 'Provider',
  'session.provider.defaultOption': 'Default provider',
  'session.provider.customPlaceholder': 'Or enter a provider name',
  'session.provider.change': 'Change provider',
  'session.provider.changing': 'Changing…',
  'session.provider.changeFailed': 'Failed to change provider',
  'session.action.changeProvider': 'Change provider',
