export default {
  ...
  'sessions.children.expand': '展开子会话',
  'sessions.children.collapse': '收起子会话',
  'sessions.children.count': '{count} 个子会话',
  ...
  'session.automationPaused.title': '自动化已暂停',
  'session.automationPaused.body': '自动任务已暂停，你仍可直接对话；点击"恢复自动化"后自动发送才会继续。',
  'session.automationPaused.resume': '恢复自动化',
  ...
  'session.provider.changeTitle': '切换 Codex provider',
  'session.provider.changeRestartNotice': '当前会话将停止并使用所选 provider 重新打开。',
  'session.provider.changeLabel': 'Provider',
  'session.provider.defaultOption': '默认 provider',
  'session.provider.customPlaceholder': '或手动输入 provider 名称',
  'session.provider.change': '切换 provider',
  'session.provider.changing': '切换中…',
  'session.provider.changeFailed': '切换 provider 失败',
  'session.action.changeProvider': '切换 provider',
